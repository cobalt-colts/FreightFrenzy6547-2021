...
@Autonomous(name = "RR Auton Blue Warehouse", group = "World")

public class RRopenCVBlueWarehouse extends LinearOpMode {
    //Various Variables ;)
    ...
    Pose2d i1Pose;
    Pose2d startPose = new Pose2d(11,62,Math.toRadians(90));
    Pose2d secondPose = new Pose2d(45, 62, Math.toRadians(90));
    ...
    public void runOpMode() throws InterruptedException{
        ...
        TrajectorySequence ts1 = drive.trajectorySequenceBuilder(startPose)
                ...
                .lineToSplineHeading(new Pose2d(0, 30, Math.toRadians(55)))
                ...
                .UNSTABLE_addTemporalMarkerOffset(0.1,() -> RTPlinearSlideDown(drive, 0)) //@TODO return linear slide
                .lineToSplineHeading(new Pose2d(11, 68, Math.toRadians(0))) //get ready to go to warehouse
                .UNSTABLE_addTemporalMarkerOffset(0.1,() -> drive.intake.setPower(0.7)) //turn on intake motors
                .strafeTo(new Vector2d(75,  90)) //go to warehouse
                .lineToSplineHeading(new Pose2d(75,75,Math.toRadians(270)))
                .UNSTABLE_addTemporalMarkerOffset(0.1,() -> drive.intake.setPower(-0.5))
                .UNSTABLE_addTemporalMarkerOffset(4.9,() -> drive.intake.setPower(0))
                .waitSeconds(5)
                .build();


        TrajectorySequence ts2 = drive.trajectorySequenceBuilder(secondPose)
                ...
                .strafeTo(new Vector2d(9,68)) //get ready to score again
        ...
        TrajectorySequence ts3 = drive.trajectorySequenceBuilder(ts2.end())
                ...
                .UNSTABLE_addTemporalMarkerOffset(0.1,() -> drive.intake.setPower(-0.7)) //outtake
                //.strafeTo(new Vector2d(50,65)) //making sure we don't go over the barrier
                .strafeTo(new Vector2d(9,70)) //get ready to score again
                .UNSTABLE_addTemporalMarkerOffset(0.1, () -> drive.intake.setPower(0))
                .UNSTABLE_addTemporalMarkerOffset(0.5,() -> RTPlinearSlideUp(drive,linearSlideHigh))
                .lineToSplineHeading(new Pose2d(-2, 40, Math.toRadians(60)))
                .UNSTABLE_addTemporalMarkerOffset(0.1,() -> boxServoDump(drive)) //score the freight
                ...
                .waitSeconds(2)
                .UNSTABLE_addTemporalMarkerOffset(0.1,() -> RTPlinearSlideDown(drive, -300)) //return linear slide
                .lineToSplineHeading(new Pose2d(9, 70, Math.toRadians(180))) //get ready to go to warehouse
                .UNSTABLE_addTemporalMarkerOffset(0.1,() -> drive.intake.setPower(0.7)) //turn on intake motors
                .strafeTo(new Vector2d(50,  70)) //go to warehouse
                .build();
